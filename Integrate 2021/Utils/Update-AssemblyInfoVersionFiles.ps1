...
function Update-AssemblyInfoVersionFiles
{
  ...
  (
    ...
    { 
        ...
        %{$_ -replace 'AssemblyCopyright\(".*"\)', "AssemblyCopyright(""Copyright (c) 20$year $copyright"")" } |
        %{$_ -replace 'AssemblyCompany\(".*"\)', "AssemblyCompany(""$company"")" } |
...
Update-AssemblyInfoVersionFiles -productVersion $productVersion -copyright $copyright -company $company